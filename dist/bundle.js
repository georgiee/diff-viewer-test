(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.DiffViewer = factory());
	...
	var isValidElementType = function (a) {
	  return "string" === typeof a || "function" === typeof a || a === e || a === m || a === g$1 || a === f || a === p$1 || a === q$1 || "object" === typeof a && null !== a && (a.$$typeof === t || a.$$typeof === r || a.$$typeof === h || a.$$typeof === k$1 || a.$$typeof === n || a.$$typeof === w$1 || a.$$typeof === x$1 || a.$$typeof === y || a.$$typeof === v$2);
	};
	...
	var T$1 = function () {
	  ...
	  return k.get(e);
	    ...
	    M$1 = function (e, t) {
	  t >= V$1 && (V$1 = t + 1), x.set(e, t), k.set(t, e);
	},
	    G$1 = "style[" + A$1 + '][data-styled-version="5.3.5"]',
	    L$1 = new RegExp("^" + A$1 + '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)'),
	    F = function (e, t, n) {
	  ...
	  return t.insertRule = function (e, t) {
	    ...
	    X$1 = {
	  isServer: !I$1,
	  useCSSOMInjection: !P$1
	},
	    Z$1 = function () {
	  function e(e, t, n) {
	    void 0 === e && (e = E$1), void 0 === t && (t = {}), this.options = v$1({}, X$1, {}, e), this.gs = t, this.names = new Map(n), this.server = !!e.isServer, !this.server && I$1 && J && (J = !1, function (e) {
	      for (var t = document.querySelectorAll(G$1), n = 0, r = t.length; n < r; n++) {
	        var o = t[n];
	        o && "active" !== o.getAttribute(A$1) && (Y$1(e, o), o.parentNode && o.parentNode.removeChild(o));
	      }
	    }(this));
	  }
	  ...
	  return t.reconstructWithOptions = function (t, n) {
	    ...
	    return this.tag || (this.tag = (n = (t = this.options).isServer, r = t.useCSSOMInjection, o = t.target, e = n ? new U$1(o) : r ? new $(o) : new W$1(o), new T$1(e)));
	    var e, t, n, r, o;
	  }, t.hasNameForId = function (e, t) {
	    return this.names.has(e) && this.names.get(e).has(t);
	  }, t.registerName = function (e, t) {
	    if (B$1(e), this.names.has(e)) this.names.get(e).add(t);else {
	      var n = new Set();
	...
	var oe$1 = ne$1("5.3.5"),
	    se$1 = function () {
	  function e(e, t, n) {
	    this.rules = e, this.staticRulesId = "", this.isStatic = (void 0 === n || n.isStatic) && re$1(e), this.componentId = t, this.baseHash = te$1(oe$1, t), this.baseStyle = n, Z$1.registerId(t);
	  }
	...
	function ce$1(e) {
	  ...
	  return l.use([].concat(u, [function (e, t, o) {
	    ...
	    return t.name || j(15), te$1(e, t.name);
	  }, 5381).toString() : "", m;
	}

	var ue$1 = /*#__PURE__*/react.createContext();
	    ue$1.Consumer;
	    var de$1 = /*#__PURE__*/react.createContext(),
	    he$1 = (de$1.Consumer, new Z$1()),
	    pe$1 = ce$1();

	function fe$1() {
	  return react_21(ue$1) || he$1;
	}

	function me$1() {
	  return react_21(de$1) || pe$1;
	}
	...
	function ye$1(e) {
	  ...
	  }, [e.stylisPlugins]), /*#__PURE__*/react.createElement(ue$1.Provider, {
	    value: u
	  }, /*#__PURE__*/react.createElement(de$1.Provider, {
	    value: l
	  }, e.children));
	}
	...
	function Ne$1(e, n, r, o) {
	  ...
	  var l;
	  return e instanceof ve$1 ? r ? (e.inject(r, o), e.getName(o)) : e : S$1(e) ? function e(t, n) {
	    var r,
	        o,
	        s = [];

	    for (var i in t) t.hasOwnProperty(i) && !_e(t[i]) && (Array.isArray(t[i]) && t[i].isCss || b(t[i]) ? s.push(be$1(i) + ":", t[i], ";") : S$1(t[i]) ? s.push.apply(s, e(t[i], i)) : s.push(be$1(i) + ": " + (r = i, null == (o = t[i]) || "boolean" == typeof o || "" === o ? "" : "number" != typeof o || 0 === o || r in unitlessKeys ? String(o).trim() : o + "px") + ";"));
	...
	function Ce$1(e) {
	  ...
	  return b(e) || S$1(e) ? Ae$1(Ne$1(g(w, [e].concat(n)))) : 0 === n.length && 1 === e.length && "string" == typeof e[0] ? e : Ae$1(Ne$1(g(e, n)));
	}

	var Re$1 = function (e, t, n) {
	  return void 0 === n && (n = E$1), e.theme !== n.theme && e.theme || t || n.theme;
	},
	    De$1 = /[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g,
	    je$1 = /(^-|-$)/g;
	...
	var Ge$1 = /*#__PURE__*/react.createContext();
	    Ge$1.Consumer;
	...
	function qe$1(e, t, n) {
	  ...
	  var C,
	    ...
	    return function (e, t, n, r) {
	      ...
	      }(Re$1(t, react_21(Ge$1), a) || E$1, t, o),
	          y = f[0],
	          g = f[1],
	          S = function (e, t, n, r) {
	        var o = fe$1(),
	            s = me$1(),
	            i = t ? e.generateAndInjectStyles(E$1, o, s) : e.generateAndInjectStyles(n, o, s);
	        return i;
	      }(i, r, y),
	          w = n,
	...
	var He$1 = function (e) {
	  return function e(t, r, o) {
	    if (void 0 === o && (o = E$1), !reactIs_27(r)) return j(1, String(r));
	...
	function We$1(e) {
	  ...
	  function l(e) {
	    ...
	    return t.server && h(l, e, t, o, n), react_28(function () {
	  ...
	  function h(e, t, n, r, o) {
	    if (u.isStatic) u.renderStyles(e, O$1, n, o);else {
	      var s = v$1({}, t, {
	        theme: Re$1(t, r, l.defaultProps)
	      });
	...
	function createDiffApi(client, diffId) {
	  ...
	  const createAnnotation = async note => {
	    const data = {
	      diff: diffId,
	      body: note.body,
	...
	const DiffViewer = () => {
	  ...
	  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("h1", null, diffData.title, " (", diffData.id, ") (Mode: ", mode, ")"), files.map(file => /*#__PURE__*/react.createElement(File, {
	    file: file,
	    key: file.index
	  })));
	};
